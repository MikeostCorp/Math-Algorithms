...
namespace mathAlgo {
    ...
    long double lengthOfLine(const long double x1, const long double x2,
                             ...
                             const long double z1, const long double z2) {
    ...
    template<typename F>
    long double halfDivisionMethod(const F func, long double a, long double b, const long double e) {
    ...
    // Secant method
    template<typename F>
    long double secantMethod(const F func, long double x0, long double x1, const long double e) {
        while (fabs(x1 - x0) > e) {
            long double tmp = x1;
    ...
    // Parabola method
    template<typename F>
    long double parabolaMethod(const F func, long double a, long double b, const long double e) {
    ...
    template <typename typeArr>
    typeArr* bSort(typeArr* arr, const int size, bool asc) {
